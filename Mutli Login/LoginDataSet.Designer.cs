...
namespace Mutli_Login {
    ...
    public partial class LoginDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(string username, string password, string fullname, string contact, string email, byte[] photo) {
...
namespace Mutli_Login.LoginDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `users` WHERE ((`username` = ?) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `fullname` IS NULL) OR (`fullname` = ?)) AND ((? = 1 AND `contact` IS NULL) OR (`contact` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`username`, `password`, `fullname`, `contact`, `email`, `pho" +
                "to`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `users` SET `username` = ?, `password` = ?, `fullname` = ?, `contact` = ?, `email` = ?, `photo` = ? WHERE ((`username` = ?) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `fullname` IS NULL) OR (`fullname` = ?)) AND ((? = 1 AND `contact` IS NULL) OR (`contact` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Mutli_Login.Properties.Settings.Default.LoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, [password], fullname, contact, email, photo FROM users";
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_fullname, string Original_contact, string Original_email) {
        ...
        public virtual int Insert(string username, string password, string fullname, string contact, string email, byte[] photo) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string fullname, string contact, string email, byte[] photo, string Original_username, string Original_password, string Original_fullname, string Original_contact, string Original_email) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string fullname, string contact, string email, byte[] photo, string Original_username, string Original_password, string Original_fullname, string Original_contact, string Original_email) {
            return this.Update(Original_username, password, fullname, contact, email, photo, Original_username, Original_password, Original_fullname, Original_contact, Original_email);
        }
    }
