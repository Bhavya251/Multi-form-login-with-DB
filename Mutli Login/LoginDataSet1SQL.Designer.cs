...
namespace Mutli_Login {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("LoginDataSet1SQL")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class LoginDataSet1SQL : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected LoginDataSet1SQL(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            LoginDataSet1SQL cln = ((LoginDataSet1SQL)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "LoginDataSet1SQL";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/LoginDataSet1SQL.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            LoginDataSet1SQL ds = new LoginDataSet1SQL();
        ...
        public partial class adminDataTable : global::System.Data.TypedTableBase<adminRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public adminRow AddadminRow(string admin) {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(string username, string password, string fullname, string email, string contact, System.DateTime birthdate, string photo, string admin) {
...
namespace Mutli_Login.LoginDataSet1SQLTableAdapters {
    ...
    public partial class adminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[admin] WHERE (([Id] = @Original_Id) AND ([admin] = @Original_a" +
                "dmin))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[admin] ([admin]) VALUES (@admin);\r\nSELECT Id, admin FROM admin" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[admin] SET [admin] = @admin WHERE (([Id] = @Original_Id) AND ([admi" +
                "n] = @Original_admin));\r\nSELECT Id, admin FROM admin WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, admin FROM dbo.admin";
        ...
        public virtual int Fill(LoginDataSet1SQL.adminDataTable dataTable) {
        ...
        public virtual LoginDataSet1SQL.adminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataSet1SQL.adminDataTable dataTable = new LoginDataSet1SQL.adminDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet1SQL.adminDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet1SQL dataSet) {
        ...
        public virtual int Delete(int Original_Id, string Original_admin) {
        ...
        public virtual int Insert(string admin) {
            if ((admin == null)) {
        ...
        public virtual int Update(string admin, int Original_Id, string Original_admin, int Id) {
            if ((admin == null)) {
                throw new global::System.ArgumentNullException("admin");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string admin, int Original_Id, string Original_admin) {
            return this.Update(admin, Original_Id, Original_admin, Original_Id);
        }
    }
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[users] ([username], [password], [fullname], [email], [contact], [birthdate], [photo], [admin]) VALUES (@username, @password, @fullname, @email, @contact, @birthdate, @photo, @admin);
SELECT Id, username, password, fullname, email, contact, birthdate, photo, admin FROM users WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [username] = @username, [password] = @password, [fullname] = @fullname, [email] = @email, [contact] = @contact, [birthdate] = @birthdate, [photo] = @photo, [admin] = @admin WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([fullname] = @Original_fullname) AND ([email] = @Original_email) AND ([contact] = @Original_contact) AND ([birthdate] = @Original_birthdate) AND ([photo] = @Original_photo) AND ([admin] = @Original_admin));
SELECT Id, username, password, fullname, email, contact, birthdate, photo, admin FROM users WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, username, password, fullname, email, contact, birthdate, photo, admin " +
                "FROM dbo.users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(LoginDataSet1SQL.usersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual LoginDataSet1SQL.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataSet1SQL.usersDataTable dataTable = new LoginDataSet1SQL.usersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet1SQL.usersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, string Original_fullname, string Original_email, string Original_contact, System.DateTime Original_birthdate, string Original_photo, string Original_admin) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string username, string password, string fullname, string email, string contact, System.DateTime birthdate, string photo, string admin) {
            if ((username == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_admin == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_admin));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_photo, 
                    string Original_admin) {
            return this.Update(username, password, fullname, email, contact, birthdate, photo, admin, Original_Id, Original_username, Original_password, Original_fullname, Original_email, Original_contact, Original_birthdate, Original_photo, Original_admin, Original_Id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(LoginDataSet1SQL dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._adminTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(LoginDataSet1SQL dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._adminTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(LoginDataSet1SQL dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._usersTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(LoginDataSet1SQL dataSet) {
            if ((dataSet == null)) {
